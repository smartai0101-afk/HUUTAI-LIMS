  ...
  const handleExport = () => {
    downloadCsv(
      ...
      displayRows.map((item) => {
        ...
        const masterKeys = new Set(["code", "name", "chemicalGroup", "manufacturer", "casNumber", "productCode"]);
        CHEMICAL_CSV_FIELD_KEYS.forEach((key) => {
          const value = item[key as keyof ChemicalView] ?? "";
          row[key] =
