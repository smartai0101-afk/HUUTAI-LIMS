...
export async function generateWorklistCode(tx: Tx, date = new Date()): Promise<string> {
...
export async function generateWorksheetCode(tx: Tx, date = new Date()): Promise<string> {
  const dateStr = formatDatePrefix(date);
