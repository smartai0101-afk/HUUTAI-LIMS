...
| **Lịch sử pha chế ISO 17025** | 🟡 **Phase 1–3 done** · Phase 4 pending · plan [`PLAN-preparation-iso.md`](PLAN-preparation-iso.md) |
...
### Ưu tiên 1 — Lịch sử pha chế ISO/IEC 17025 🟡 (Phase 1–3 done · Phase 4 pending)
...
- [ ] **QA browser:** Draft → Prepared (trừ tồn) → Checked → Approved · amend · xóa mềm · đổi mã sau xóa (TG2)
...
**Track A — ISO Phase 4 Báo cáo (lớn)**
1. `/preparation-history` + export Excel 14 cột · nav `preparation_history`
2. Cập nhật `prepared-excel.ts` / import · seed chain `links.ts`

**Track B — QA browser (ngắn)**
...
```
Đọc HANDOFF.md (§ Ghi chú phiên + § Lịch sử pha chế ISO) và PLAN-preparation-iso.md.
Triển khai Phase 4 ISO (/preparation-history + Excel 14 cột + nav permission).
Hoặc QA browser checklist §8 trên prod/local.
Chỉ đọc file liên quan — không scan toàn repo.
```

### File tham chiếu (ISO pha chế — Phase 1–3 done · Phase 4 pending)
